 ...
 * @author Sammy
 * @notice This is for creating an untamperable decentralised smart contract
 * @dev this contract implements chainlink VRF V2 and Chainlink keepers
 */

contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
        /*  Type declarartions  */
    enum RaffleState {OPEN, CALCULATING} //basically what is happening here is uint256 0 = OPEN, 1 = CALCULATING
     ...
     * The following should be true in other to return true: 
    ...
    function performUpkeep(bytes calldata /*performData*/) external override {
        ...
        // chainlink vrf is a two trnsaction process
